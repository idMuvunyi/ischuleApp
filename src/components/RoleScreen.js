...
import { PrimaryButton, SuccessButton } from '../reusable-components/Button'
        ...
        <SafeAreaView style={{flex:1, backgroundColor:'#fff'}}>
            <View style={{flex:1, justifyContent:'center', alignItems:'center',}}>
                <View style={styles.textLogoWrapper}>
                    <Text style={styles.textLogo}>iSchule</Text>
                </View>
                    <Text style={styles.roleText}>What is you role?</Text>
                <View style={styles.rolesWrapper}>
                    <PrimaryButton title="Employer" onPress={() => handleLoginEmployer()} />
